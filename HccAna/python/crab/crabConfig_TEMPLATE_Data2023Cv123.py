...
config.JobType.psetName = '/afs/cern.ch/work/a/azaza/HccAna/CMSSW_13_0_13/src/Hcc/HccAna/python/templateData_Prompt2023Cv123_JECdB.py'
#config.JobType.outputFiles = ['OUTFILENAME.root']
#config.JobType.scriptExe = 'submitFileCrab.sh'
config.JobType.inputFiles  = ['/afs/cern.ch/work/a/azaza/HccAna/CMSSW_13_0_13/src/Hcc/HccAna/python/Summer23Prompt23_RunCv123_V1_DATA.db', '/afs/cern.ch/work/a/azaza/HccAna/CMSSW_13_0_13/src/Hcc/HccAna/python/Summer23Prompt23_RunCv123_JRV1_DATA.db', '/afs/cern.ch/work/a/azaza/HccAna/CMSSW_13_0_13/src/Hcc/HccAna/python/Summer23Prompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt']
