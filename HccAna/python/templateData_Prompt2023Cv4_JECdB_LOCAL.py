...
#process.GlobalTag = GlobalTag(process.GlobalTag, 'Summer23Prompt23_RunCv4_V1_DATA','')
...
'/store/data/Run2023C/JetMET0/MINIAOD/PromptReco-v4/000/367/770/00000/16e0d59e-115c-4f05-afbd-18923e32d880.root',
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string("out_JetMET_Prompt2023Cv4.root")
)
...
process.jer = cms.ESSource("PoolDBESSource",
        ...
        toGet = cms.VPSet(
            ...
            cms.PSet(
                ...
                tag    = cms.string('JR_Summer23Prompt23_RunCv4_JRV1_DATA_PtResolution_AK4PFPuppi'),
            ...
            cms.PSet(
                ...
                tag    = cms.string('JR_Summer23Prompt23_RunCv4_JRV1_DATA_SF_AK4PFPuppi'),
                label  = cms.untracked.string('AK4PFPuppi')
                ),
            ),
...
process.Ana = cms.EDAnalyzer('HccAna',
			      ...
			      AK8PuppiJetSrc       = cms.untracked.InputTag("slimmedJetsAK8"),
                              ...
                              JECUncFileAK4Src = cms.string("/afs/cern.ch/work/a/azaza/HccAna/CMSSW_13_0_13/src/Hcc/HccAna/python/Summer23Prompt23_V1_MC_UncertaintySources_AK4PFPuppi.txt"), #also for data it is recommended to use the same uncertainty file as for MC, check if recommendations change in future
                              #for crab
