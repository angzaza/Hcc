...
'/store/data/Run2023D/ParkingVBF6/MINIAOD/PromptReco-v1/000/369/911/00000/9ef28b77-6e3d-4607-9ebf-8779d238d881.root',
'/store/data/Run2023D/ParkingVBF6/MINIAOD/PromptReco-v1/000/369/870/00000/095baa58-cdf3-4921-b2d5-0ff610d0ce06.root',
'/store/data/Run2023D/ParkingVBF6/MINIAOD/PromptReco-v1/000/369/870/00000/775d98ce-be85-4109-bdf2-03ac1d0acd69.root',
'/store/data/Run2023D/ParkingVBF6/MINIAOD/PromptReco-v1/000/369/873/00000/0da7bdc8-8493-4e8d-8525-307dbd2ba023.root',
'/store/data/Run2023D/ParkingVBF6/MINIAOD/PromptReco-v1/000/369/873/00000/4e203520-1539-4a52-b0d8-0d25fa79e37f.root',
...
process.TFileService = cms.Service("TFileService",
                                   ...
                                   fileName = cms.string("out_JetMET_Prompt2023D.root")
)
...
process.jec = cms.ESSource("PoolDBESSource",
                           ...
                           toGet =  cms.VPSet(
                              cms.PSet(
                                 ...
                                 tag = cms.string("JetCorrectorParametersCollection_Summer23BPixPrompt23_RunD_V1_DATA_AK4PFPuppi"),
...
process.jer = cms.ESSource("PoolDBESSource",
        ...
        toGet = cms.VPSet(
            ...
            cms.PSet(
                ...
                tag    = cms.string('JR_Summer23BPixPrompt23_RunD_JRV1_DATA_PtResolution_AK4PFPuppi'),
            ...
            cms.PSet(
                ...
                tag    = cms.string('JR_Summer23BPixPrompt23_RunD_JRV1_DATA_SF_AK4PFPuppi'),
                label  = cms.untracked.string('AK4PFPuppi')
                ),
            ),
