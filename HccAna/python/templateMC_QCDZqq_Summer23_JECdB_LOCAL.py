...
#process.slimmedJetsJECDown=process.updatedPatJetsUpdatedJEC.clone(variation=cms.int32(-1))
#process.slimmedJetsJECUp=process.updatedPatJetsUpdatedJEC.clone(variation=cms.int32(1))
...
process.Ana = cms.EDAnalyzer('HccAna',
                              ...
                              #AK4PuppiJetJECUpSrc       = cms.InputTag("slimmedJetsJECUp"),
                              #AK4PuppiJetJECDownSrc       = cms.InputTag("slimmedJetsJECDown"),
...
process.p = cms.Path(process.jecSequence* 
                     ...
                     #process.slimmedJetsJECDown*
                     #process.slimmedJetsJECUp*
                     process.jerSequence*
