...
// Mon Jun 19 16:46:55 2023 by ROOT version 6.24/07
// from TTree passedEvents/passedEvents
// found on file: out_Data2023.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop_control(TString type, TString datasetName, TString era);
   virtual Bool_t   Notify();
   virtual void     Show(Long64_t entry = -1);
   //virtual void     TreeFin_Fill(TTree *tree, Double_t &isMC);
   //virtual void     TreeFin_Init(TTree *tree, Double_t &isMC);
};

#endif

#ifdef myAnalizer_control_cxx
...
#endif // #ifdef myAnalizer_control_cxx
