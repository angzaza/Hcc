...
def parseOptions():
    ...
    parser.add_option('-c', '--cfg', dest='CONFIGFILE', type='string', default='/afs/cern.ch/work/a/azaza/HccAna/CMSSW_13_0_13/src/Hcc/HccAna/python/crab/crabConfig_TEMPLATE_Data2023Cv4.py', help='configuration template')
